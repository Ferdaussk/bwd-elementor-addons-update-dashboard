...
?>
<div class="thecpg_catagory_2 thecpg-slider-common">
    <div class="container-fluid">
        <div class="row <?php echo esc_attr($thecpg_col_align); ?>">
            ...
            <?php } } else{echo '<div class="thecpg_none_product">'.esc_html__('You don\'t have any products. Please add your products.', 'bwd-elementor-addons').'</div>';} ?>
        </div>
    </div>
</div>