            ...
            <div class="<?php echo esc_attr($bwdbp_the_section); ?> g-0">
                <div class="row <?php echo esc_attr($bwdbp_align); ?> <?php echo esc_attr($bwdbp_box_column_gap); ?>">
					...
					echo '<div class="bwdbp_box_margin_cmn padding_LR mb-30 col-sm-3 col-lg-4 col-md-6 column_number">'; ?>
                        <div class="bwdbp_blog_box bwdbp_box_padding_cmn bwdbp_box_style_cmn">
                            ...
                            <div class="bwdbp_blog_bottom_part bwdbp_box_style_cmn <?php echo esc_attr($bwdbp_cont_align); ?>">
                                <?php
                                if($bwdbp_yes_value === $bwdbp_categories_swtcher){ ?>
                                <div class="bwdbp_category_option">
                                    <?php
                                    if('show_main_cat' === $bwdbp_cat_show_status){ ?>
                                ...
                                <div class="bwdbp_author_info">
                                    <?php if($bwdbp_yes_value === $bwdbp_author_swtcher){ ?>
                                        <div class="bwdbp_author-img">
                                            ...
                                            <?php } elseif('gravatar' === $bwdbp_author_indicator){ ?>
                                                <?php
                                                echo wp_kses_post(get_avatar( get_the_author_meta( 'ID' ), $size = '50', $default = '', $alt = 'Author Image', $args = array( 'class' => 'wt-author-img' ) )); 
                                                } ?>
                                    ...
                                    <div class="bwdbp_blog_meta">
                                        <div class="bwdbp_blog_date bwdbp-btm-gap"><?php if('show' === $bwdbp_taxo_icon){ ?><i class="bwdbp_icons far fa-calendar-alt"></i><?php } echo get_the_date(esc_html($bwdbp_blog_date_format)); ?></div>
                                        <?php }
