...
<div class="bwdcrtplst_blogPost_1 bwdcrtplst_blogPost_list_20 bwdcrtplst-slider-common <?php echo esc_attr($settings['bwdcrtplst_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['bwdcrtplst-blogpost-custom-id'] ); ?>">
                ...
                <div class="bwdcrtplst_blog_box bwdcrtplst_box_sha">
                    ...
                    <div class="bwdcrtplst_blog_bottom_part bwdcrtplst_box_style_cmn <?php echo esc_attr($bwdcrtplst_cont_align); ?>">
                        <div class="bwdcrtplst_blog_meta">
                            ...
                            <?php } ?>
                            <?php if('yes' === $settings['bwdcrtplst_sale']){ ?>
                            ...
                            <?php } ?>
                            <?php include(__DIR__.'/../wplccommon/star_rating.php'); ?>
                            <?php if('yes' === $settings['bwdcrtplst_cat']){ ?>
