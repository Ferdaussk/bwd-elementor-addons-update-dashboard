...
?>
<div class="bwdbpl_blogPost_1 bwdbpl_blogPost_list_20">
                    ...
                    <div class="bwdbpl_blog_bottom_part bwdbpl_box_style_cmn">
                        <div class="bwdbpl_blog_meta <?php echo esc_attr($bwdbpl_cont_align); ?>">
                            ...
                            <?php if('icon' === $bwdbpl_author_indicator){ ?>
                                <i class="bwdbpl_icons <?php echo esc_attr($settings['bwdbpl_author_icon']['value']); ?>"></i><?php } elseif('gravatar' === $bwdbpl_author_indicator){ ?><?php echo wp_kses_post(get_avatar( get_the_author_meta( 'ID' ), $size = '50', $default = '', $alt = 'Author Image', $args = array( 'class' => 'wt-author-img' ) )); 
