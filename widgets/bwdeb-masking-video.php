	   ...
	   $this->add_control(
		   ...
		   [
			   ...
			   'options' => [
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/masking-video-addon-for-elementor/" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
				]
	   );
	   	//mask position
	   $this->add_responsive_control(
