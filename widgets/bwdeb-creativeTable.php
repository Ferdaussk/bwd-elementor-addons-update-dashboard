...
class BWDEB_bwdct_creativetable extends Widget_Base {
	...
	public function get_name() {
		return esc_html__( 'bwd-elementor-addons', 'bwd-elementor-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => 'See <a href="https://bestwpdeveloper.com/elementor-data-table" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
