...
?>
<div class="wppgpc-card-area-2 wppgpc-slider-common <?php echo esc_attr($settings['wppgpc_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['wppgpc-product-custom-id'] ); ?>">
			...
			<div class="wppgpc-item">
				<div class="wppgpc-card">
                    ...
                    <div class="wppgpc-card-icon">
                        <?php echo '<a href="' . esc_url($product->add_to_cart_url()) . '"><i class="'.esc_attr($settings['wppgpc_cart_button_icon']['value']).'"></i></a>'; ?>
                    </div>
                    <?php } ?>
					<div class="wppgpc-contentbx <?php echo esc_attr($wppgpc_cont_align); ?>">
						...
						<div class="wppgpc-btn-ptype <?php echo esc_attr($wppgpc_cont_align); ?>">
