...
<div class="crtplst_blogPost_1 crtplst_blogPost_2 crtplst_blogPost_list_21">
    <div class="container-fluid PLR_5">
        <div class="row g-0">
        ...
        while ( $crtplst_all_products->have_posts() ) : $crtplst_all_products->the_post();
            global $product; ?>
            <div class="col-lg-12 mb-60 crtplst_wrap">
                <div class="crtplst_blog_box crtplst_box_sha">
                <?php /*<div>*/ $this->crtplst_product_thumbnail_with_css(); ?></div>
                    <div class="crtplst_blog_bottom_part crtplst_box_style_cmn <?php echo esc_attr($crtplst_cont_align); ?>">
                        <div class="crtplst_blog_meta">
                            ...
                            <div class="crtplst_the_tags">
                                <div class="crtplst_blog_tag"><?php echo wp_kses_post(wc_get_product_tag_list(get_the_id())); ?></div>
                            </div>
                            <?php }
                            if('yes' === $settings['crtplst_sale']){ ?>
                            <div class="crtplst_the_tags <?php echo esc_attr($crtplst_cont_align); ?>">
                            ...
                            <?php }
                            include(__DIR__.'/../wplicommon/star_rating.php');
                            if('yes' === $settings['crtplst_cat']){ ?>
                        ...
                        <?php }
                        if('yes' === $settings['crtplst_description']){ ?>
                        ...
                        <?php }
                        if('yes' === $settings['crtplst_cart_btn']){ ?>
