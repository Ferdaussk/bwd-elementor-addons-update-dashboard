	...
	protected function _register_controls(){
		...
		$this->add_control(
			...
			[
				...
				'default' => 'Default',
				'description' => 'See <a href="https://bestwpdeveloper.com/code-highlighter" target="_blank"><b>DEMO</b></a>. Get <a href="https://bestwpdeveloper.com/pricing/" target="_blank"><b>PRO...</b></a>.',
			]
		);
		$this->add_control(
			'codentor_language',
